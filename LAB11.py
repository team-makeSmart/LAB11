...
#TODO find a solution so that when user enters 'MAP' or 'HELP' that it doesn't automatically print the room details
...
def main():
    ...
    while True:
        ...
        if userCommand == 'HELP':
            ...
            if x == 1 and y == 0: #Check if in the coordinates of the Dark Room
                printNow('************************')
